...
urlpatterns =[
    ...
    url(r'category/(?P<category_name_slug>[\w\-]+)/sort_dec/$', show_category_price_dec, name='show_category_price_dec'),
    url(r'category/(?P<category_name_slug>[\w\-]+)/sort_inc/$', show_category_price_inc, name='show_category_price_inc'),
